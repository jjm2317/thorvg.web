  ...
  private async _init(): Promise<void> {
    ...
    try {
      ...
      await this._create({
        ...
        renderConfig: {
          ...this.renderConfig,
          devicePixelRatio: this.renderConfig?.devicePixelRatio || window.devicePixelRatio || 1,
          freezeOnOffscreen: this.renderConfig?.freezeOnOffscreen ?? true,
          autoResize: this.renderConfig?.autoResize ?? true,
        },
